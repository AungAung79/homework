...
public class LdaGibbsSampling {
	...
	public static void main(String[] args) throws IOException {
		...
		LdaPredicting predicting=new LdaPredicting();
		predicting.init(model.K, model.V, model.alpha, model.beta, model.iterations, model.nkt, model.nktSum);
		predicting.predict(docSet);
