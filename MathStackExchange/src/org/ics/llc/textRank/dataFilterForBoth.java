...
public class dataFilterForBoth {
	...
	public void scan()
	{
		File file=new File("data/QuestionsBody_removeLowNumTags.txt");
		...
		try {
			...
			file = new File("data/QuestionsTitles_removeLowNumTags.txt");
			...
			File stat=new File("data/wordFreForBoth.txt");
			...
			stat=new File("data/wordFreRemoved50ForBoth.txt");
	...
	{
		File file=new File("data/QuestionsBody_removeLowNumTags.txt");
		File title=new File("data/QuestionsTitles_removeLowNumTags.txt");
		File pro=new File("data/QuestionsBothProcessed.txt");
		String line=new String();
		try {
			BufferedReader reader=new BufferedReader(new InputStreamReader(new FileInputStream(file)));
