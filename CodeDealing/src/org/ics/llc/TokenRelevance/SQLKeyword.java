...
public class SQLKeyword {
	...
	public SQLKeyword()
	{
		String word = "begin end start commit rollback savepoint lock alter create drop rename call "
		...
		String built_in = "array bigint binary bit blob boolean char character date dec decimal float int integer interval number "
	...
	{
		try {
			PrintWriter pw = new PrintWriter("/Users/jimmy/StackOverflow/parsed-data/Token/sqlkeyword.txt");
